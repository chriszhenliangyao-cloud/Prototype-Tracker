...
import { closeOtherApprovalRequest } from "@/lib/otherApprovals";
...
export async function POST(request: NextRequest) {
  ...
  const result = await closeOtherApprovalRequest({
  ...
  return NextResponse.json({ ...result, message: "Request rejected and closed." });
}
