...
import { withdrawOtherApprovalRequest } from "@/lib/otherApprovals";
...
export async function POST(request: NextRequest) {
  ...
  const result = await withdrawOtherApprovalRequest({
  ...
  return NextResponse.json({ ...result, message: "Request withdrawn from approval." });
}
