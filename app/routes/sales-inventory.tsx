...
function HistoryModal({ history, snapshots, revisionLogs, syncedMonth, onClose }: { history: HistoryRow[]; snapshots: ForecastSnapshot[]; revisionLogs: ChangeLog[]; syncedMonth: string; onClose: () => void }) {
	...
	const actualRows = history
		...
		.sort((a, b) => a.month.localeCompare(b.month) || a.model.localeCompare(b.model) || a.product.localeCompare(b.product));
	const snapshotRows = snapshots
		...
		.sort((a, b) => a.archiveMonth.localeCompare(b.archiveMonth) || a.forecastMonth.localeCompare(b.forecastMonth) || a.model.localeCompare(b.model));
	const logRows = revisionLogs
		...
		.sort((a, b) => (b.time === "Now" ? "9999" : b.time).localeCompare(a.time === "Now" ? "9999" : a.time) || a.model.localeCompare(b.model) || a.month.localeCompare(b.month) || a.field.localeCompare(b.field));
