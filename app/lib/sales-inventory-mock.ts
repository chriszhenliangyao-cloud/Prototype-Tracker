...
export const initialPlanningMonths = ["2026-07", "2026-08", "2026-09"];

export const initialPlanningRows: PlanningRow[] = [
	{ model: "P61L-P2", product: "Pocket 10K 45W", category: "Power Bank", launchDate: "2026-01-15", inventory: 4000, safetyStock: 1200, firstForecast: 3500, firstMass: 5000, months: { "2026-07": { forecast: 1800, supply: 400 }, "2026-08": { forecast: 1700, supply: 400 }, "2026-09": { forecast: 1400, supply: 300 } } },
	{ model: "P51L-P2", product: "Pocket 20K 45W", category: "Power Bank", launchDate: "2026-02-18", inventory: 11000, safetyStock: 1600, firstForecast: 8000, firstMass: 12000, months: { "2026-07": { forecast: 0, supply: 2000 }, "2026-08": { forecast: 1700, supply: 1200 }, "2026-09": { forecast: 1900, supply: 1400 } } },
	{ model: "PM61-Black", product: "MagPro Slim 10K Qi2.2 – Black", category: "Power Bank", launchDate: "2026-03-05", inventory: 6500, safetyStock: 900, firstForecast: 2500, firstMass: 3500, months: { "2026-07": { forecast: 0, supply: 700 }, "2026-08": { forecast: 0, supply: 800 }, "2026-09": { forecast: 1200, supply: 900 } } },
	{ model: "PX51", product: "MagPro Neo 10K Qi2.0", category: "Power Bank", launchDate: "2026-08-22", inventory: 2200, safetyStock: 700, firstForecast: 1800, firstMass: 2800, months: { "2026-07": { forecast: 0, supply: 600 }, "2026-08": { forecast: 1800, supply: 200 }, "2026-09": { forecast: 900, supply: 650 } } },
	{ model: "WM321", product: "MagPro 3-in-1 Station", category: "Wireless Charger", launchDate: "2026-10-16", inventory: 2500, safetyStock: 400, firstForecast: 1200, firstMass: 1600, months: { "2026-07": { forecast: 0, supply: 200 }, "2026-08": { forecast: 0, supply: 300 }, "2026-09": { forecast: 0, supply: 400 } } },
	{ model: "WAL101", product: "Leopard Fold Charger 100W – EU", category: "Charger", launchDate: "2026-11-06", inventory: 400, safetyStock: 250, firstForecast: 800, firstMass: 1000, months: { "2026-07": { forecast: 0, supply: 100 }, "2026-08": { forecast: 0, supply: 150 }, "2026-09": { forecast: 0, supply: 250 } } },
];
