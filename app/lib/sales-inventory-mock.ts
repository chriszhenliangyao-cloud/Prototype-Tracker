...
export const initialPlanningMonths = ["2026-08", "2026-09", "2026-10"];

export const initialPlanningRows: PlanningRow[] = [
	{ model: "P61L-P2", product: "Pocket 10K 45W", category: "Power Bank", launchDate: "2026-01-15", inventory: 4000, firstForecast: 3500, firstMass: 5000, months: { "2026-08": { forecast: 1800, supply: 1800 }, "2026-09": { forecast: 2000, supply: 2600 }, "2026-10": { forecast: 1400, supply: 500 } } },
	{ model: "P51L-P2", product: "Pocket 20K 45W", category: "Power Bank", launchDate: "2025-11-20", inventory: 3000, firstForecast: 8000, firstMass: 12000, months: { "2026-08": { forecast: 1200, supply: 700 }, "2026-09": { forecast: 1900, supply: 1400 }, "2026-10": { forecast: 1200, supply: 700 } } },
	{ model: "PX51", product: "MagPro Neo 10K Qi2.0", category: "Power Bank", launchDate: "2026-08-01", inventory: 0, firstForecast: 1800, firstMass: 2800, months: { "2026-08": { forecast: 1800, supply: 200 }, "2026-09": { forecast: 900, supply: 800 }, "2026-10": { forecast: 900, supply: 800 } } },
	{ model: "PM61-Black", product: "MagPro Slim 10K Qi2.2 – Black", category: "Power Bank", launchDate: "2025-09-10", inventory: 5000, firstForecast: 2500, firstMass: 3500, months: { "2026-08": { forecast: 800, supply: 700 }, "2026-09": { forecast: 1200, supply: 1400 }, "2026-10": { forecast: 1200, supply: 1200 } } },
	{ model: "WM321", product: "MagPro 3-in-1 Station", category: "Wireless Charger", launchDate: "2026-10-01", inventory: 0, firstForecast: 1200, firstMass: 1600, months: { "2026-08": { forecast: 300, supply: 0 }, "2026-09": { forecast: 600, supply: 0 }, "2026-10": { forecast: 300, supply: 1600 } } },
	{ model: "WAL101", product: "Leopard Fold Charger 100W – EU", category: "Charger", launchDate: "2026-09-15", inventory: 250, firstForecast: 800, firstMass: 1000, months: { "2026-08": { forecast: 150, supply: 0 }, "2026-09": { forecast: 180, supply: 150 }, "2026-10": { forecast: 120, supply: 150 } } },
];

export const initialHistoryRows: HistoryRow[] = [
	{ month: "2026-07", model: "P61L-P2", product: "Pocket 10K 45W", category: "Power Bank", forecast: 1750, actualSales: 1700, supplyPlan: 2600, actualSupply: 2590, beginningInventory: 3110, endingInventory: 4000 },
	{ month: "2026-07", model: "P51L-P2", product: "Pocket 20K 45W", category: "Power Bank", forecast: 1650, actualSales: 1600, supplyPlan: 2530, actualSupply: 2500, beginningInventory: 2100, endingInventory: 3000 },
	{ month: "2026-07", model: "PX51", product: "MagPro Neo 10K Qi2.0", category: "Power Bank", forecast: 0, actualSales: 0, supplyPlan: 0, actualSupply: 0, beginningInventory: 0, endingInventory: 0 },
	{ month: "2026-07", model: "PM61-Black", product: "MagPro Slim 10K Qi2.2 – Black", category: "Power Bank", forecast: 900, actualSales: 880, supplyPlan: 1420, actualSupply: 1395, beginningInventory: 4485, endingInventory: 5000 },
	{ month: "2026-07", model: "WM321", product: "MagPro 3-in-1 Station", category: "Wireless Charger", forecast: 0, actualSales: 0, supplyPlan: 0, actualSupply: 0, beginningInventory: 0, endingInventory: 0 },
	{ month: "2026-07", model: "WAL101", product: "Leopard Fold Charger 100W – EU", category: "Charger", forecast: 0, actualSales: 0, supplyPlan: 250, actualSupply: 250, beginningInventory: 0, endingInventory: 250 },
