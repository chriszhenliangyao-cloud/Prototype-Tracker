/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d7b1ea09e20c6c9905f0ad300d6a17d8)
...
declare namespace Cloudflare {
	...
	interface Env {
		DB: D1Database;
		FOLLOW_UP_EMAIL_TO: "ivy.bai@iniushop.com";
		FOLLOW_UP_EMAIL_FROM: "ProtoTrack <onboarding@resend.dev>";
		PROJECT_PROGRESS_URL: "https://prototype-tracker.prototype-tracking.workers.dev/project-progress";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FOLLOW_UP_EMAIL_TO" | "FOLLOW_UP_EMAIL_FROM" | "PROJECT_PROGRESS_URL" | "RESEND_API_KEY">> {}
}
